...
from .karma_sgd_fast import _karma_sgd
from .karma_sgd_fast import _binary_sgd, _binary_sgd_test
from .karma_sgd_fast import _karma_predict
#from .karma_sgd_fast import _multiclass_sgd

from .karma_sgd_fast import ModifiedHuber
from .karma_sgd_fast import Hinge
from .karma_sgd_fast import SquaredHinge
from .karma_sgd_fast import Log
from .karma_sgd_fast import SquaredLoss
from .karma_sgd_fast import Huber
from .karma_sgd_fast import EpsilonInsensitive

from .karma_sgd_fast import MulticlassLog
from .karma_sgd_fast import MulticlassHinge
from .karma_sgd_fast import MulticlassSquaredHinge
...
class TSGDClassifier(BaseClassifier, _BaseSGD):
    ...
    def __init__(self, loss="hinge", penalty="l2",
                 ...
                 callback=None, n_calls=100, verbose=0, black_out = 0.0, test_freq = 1, disp_freq = 1):
        self.loss = loss
...
class KSGDClassifier(BaseClassifier, _BaseSGD):
    """Estimator for learning linear classifiers by SGD.
    ...
    def __init__(self, loss="hinge", penalty="l2",
                 ...
                 epsilon=0.01, fit_intercept=True, intercept_decay=1.0,
                 max_iter=10, shuffle=True, random_state=None,
                 callback=None, n_calls=100, gamma=1.0, verbose=0):
        self.loss = loss
        self.penalty = penalty
        self.multiclass = multiclass
        self.alpha = alpha
    ...
    def score(self, X, y, sample_weight=None):
        test_x = get_dataset(X)

        #print self.updates
        acc = _karma_predict(self,
                self.train_x,
                test_x,
                y,
                self.gamma,
                self.upd_,
                self.seq_, self.verbose)
        return acc

    def train_score(self):
        return 1.0 - self.tr_err
